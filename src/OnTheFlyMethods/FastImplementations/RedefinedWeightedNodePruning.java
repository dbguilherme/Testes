...
public class RedefinedWeightedNodePruning extends MetaBlocking.EnhancedMetaBlocking.FastImplementations.RedefinedWeightedNodePruning {
    ...
    public double[] getPerformance() {
        ...
        System.out.println( "duplicatePropagation.getNoOfDuplicates()---> "+duplicatePropagation.getNoOfDuplicates() + "    duplicatePropagation.getExistingDuplicates()  "+  duplicatePropagation.getExistingDuplicates());
        ...
        System.out.println("número comparaçõs "+ totalComparisons);
        return metrics;
    }
